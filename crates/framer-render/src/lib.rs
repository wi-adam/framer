...
pub use build::{
    RenderAssets, RenderOptions, SceneFraming, build_scene, build_scene_with_assets,
    scene_from_model, scene_from_model_with_assets,
};
...
mod tests {
    ...
    fn tiny_scene() -> Scene {
        ...
        let camera = Camera::orbit(Vec3::ZERO, 2.0, -0.6, 0.5, 1.0, 1.0, 40.0, 1.0);
